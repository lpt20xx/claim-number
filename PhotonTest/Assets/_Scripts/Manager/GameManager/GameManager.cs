...
public class GameManager : MonoBehaviour
{
    ...
    public Vector2 xPosLimit = new Vector2(-25, 25);
    public Vector2 yPosLimit = new Vector2(-12, 12);
    ...
    public Transform numberSpawner;

    //Scoreboard
    [Header("Scoreboard")]
    public GameObject scoreboard;
    public PhotonScore photonScore;
    ...
    protected virtual void SpawnNumber(int number, int lineNumber, int colNumber)
    {
        ...
        numberObj.transform.SetParent(numberSpawner, false);
    ...
    public virtual void NumberOnClaimed(int number)
    {
        ...
        if(photonNumber.Claimed() == 1)
        {
            photonScore.GetPlayerScore();
        }
    }
